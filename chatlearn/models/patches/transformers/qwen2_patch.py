...
def qwen2_sp_attention_forward(
        self,
    ...
    if sp_group is not None:
        ...
        # When sp_size > num_key_value_heads, repeat_kv before all2all
        ...
        # split on n_head dim, gather on seq_len
...
def register_sp_attention_forward():
    modeling_qwen2.Qwen2Attention.forward = qwen2_sp_attention_forward
