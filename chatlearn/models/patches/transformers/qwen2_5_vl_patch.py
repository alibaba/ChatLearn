...
from transformers.modeling_flash_attention_utils import fa_peft_integration_check, _upad_input
...
def _flash_attention_forward(
    ...
    deterministic: Optional[bool] = None, # pylint: disable=unused-argument
