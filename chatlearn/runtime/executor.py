...
class Executor:
    ...
    def compute_loop_one_model(self, model_node: ModelNode, num_batch=None):
        ...
        for step in range(num_batch):
            ...
            to_onload = step < replica_num and ((model.is_colocate and model.enable_offload) or model.name=="agent")
            to_offload = step >= last_step_start and ((model.is_colocate and model.enable_offload) or model.name=="agent")
