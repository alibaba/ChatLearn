...
def _load_checkpoint(queue, args):
    ...
    try:
        ...
        from megatron.training.checkpointing import load_args_from_checkpoint, load_checkpoint # pylint: disable=redefined-outer-name
    ...
    if checkpoint_args.expert_model_parallel_size > 1:
