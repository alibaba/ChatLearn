...
# Tested on 8x8xH20-3e with 140G VRAM
set -x
...
export exp_name=qwen3-grpo-235b-a22b
python chatlearn/entrypoint.py grpo \
        ...
        runtime_args.train_micro_batch_size=32 \
        ...
        models.policy_trainer.max_token_in_packing=10000 \
        ...
        models.policy_trainer.load=${CHATLEARN}/pretrained_models/Qwen3-235B-A22B/ \
        models.policy_trainer.optimizer.lr=2e-6 \
        models.policy_trainer.pos_clip_ratio=0.2 \
        models.policy_trainer.neg_clip_ratio=0.2 \
        models.ref_policy.generation_batch_size=32 \
        models.policy.generation_batch_size=256 \
        models.policy.enforce_eager=True \
        models.policy.tensor_model_parallel_size=8 \
        models.policy.seq_length=4096 \
        models.policy.max_seq_len_to_capture=4348 \
