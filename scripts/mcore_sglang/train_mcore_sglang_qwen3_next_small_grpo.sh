...
hf_ckpt_path=${CHATLEARN}/pretrained_models/Qwen3-Next-80B-A3B-Instruct-small
mcore_ckpt_path=${CHATLEARN}/pretrained_models/Qwen3-Next-80B-A3B-Instruct-small-to-mcore

export DEBUG_SYNC_PARAMETERS_PATH="/mnt/data/gushen.hkw/logs/qwen3_next_small_cvt"

exp_name="test_qwen3_next"
...
python chatlearn/entrypoint.py grpo --config-file template/grpo_megatron.yaml \
        ...
        runtime_args.sample_per_episode=64 \
        runtime_args.train_global_batch_size=64 \
        ...
        models.policy_trainer.model_provider_module=qwen3_next.pretrain_qwen3_next \
        ...
        models.policy_trainer.expert_model_parallel_size=2 \
        ...
        models.reward.generation_batch_size=8 \
        models.policy.load=${hf_ckpt_path} \
        models.policy.generation_batch_size=16 \
