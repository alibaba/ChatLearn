...
python chatlearn/entrypoint.py grpo --config-file template/grpo_megatron.yaml \
        ...
        models.policy_trainer.decoder_first_pipeline_num_layers=14 \
        models.policy_trainer.decoder_last_pipeline_num_layers=13 \
        models.policy_trainer.expert_tensor_parallel_size=2 \
        models.policy_trainer.expert_model_parallel_size=2 \
        models.policy_trainer.context_parallel_size=2 \
