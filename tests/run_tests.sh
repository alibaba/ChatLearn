...
function run_all_tests {
  ...
  run_test python test_balance_hep_pp_unbalance_ep_tp.py -c "configs/test_param_sync.yaml"
...
if [ "$1" == "" ]; then
  ...
  run_test python test_balance_hep_pp_unbalance_ep_tp.py -c "configs/test_param_sync.yaml"
  # run_test python test_balance_hep_unbalance_ep_tp_pp.py -c "configs/test_param_sync.yaml"
