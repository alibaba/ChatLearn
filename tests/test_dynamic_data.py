...
rlhf.get_args().rlhf_args.dynamic_train_samples = True
rlhf.get_args().rlhf_args.stream_data_loader_type = "dynamic"
sample_per_episode = rlhf.get_args().rlhf_args.sample_per_episode
...
assert engine.trainer.num_training_iteration() == 2
