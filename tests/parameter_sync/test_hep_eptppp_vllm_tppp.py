...
Current test case: 
(dst_ep, dst_tp, dst_pp, src_ep, src_tp, src_pp) = (1, 4, 2, 2, 2, 2).
"""
...
def test_hep_eptppp_vllm_tp_dst_ep1_tp4_pp2_src_ep2_tp2_pp2():
    ...
    assert comm_pairs_for_except_routed_experts_stage1 == [(0, 8), (1, 10), (4, 13), (5, 15)]
    assert comm_pairs_for_except_routed_experts_stage2 == [(8, 9), (10, 11), (13, 12), (15, 14)]

    print(f"pass test_case (dst_ep, dst_tp, dst_pp, src_ep, src_tp, src_pp): {tuples}")
    engine.stop()

TEST_CASE = [test_hep_eptppp_vllm_tp_dst_ep1_tp4_pp2_src_ep2_tp2_pp2]
