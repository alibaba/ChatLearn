...
[ -z "$MASTER_PORT" ] && export MASTER_PORT=12355
...
CHECKPOINT_PATH=${CHATLEARN}/output/step2_reward/bloomsft_hh_rm_$(date +%F)_gpt_${MODEL_SIZE}_${NNODES}w${GPUS_PER_NODE}g_tp${tp}_pp${pp}_mb${mb}_seqlen${seq_len}
