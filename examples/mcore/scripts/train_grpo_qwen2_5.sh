...
export PYTHONPATH=${MEGATRON_PATH}:${CHATLEARN}:${CHATLEARN}/examples/mcore:$PYTHONPATH
...
export reward_num_layers=${policy_num_layers}
export reward_hidden_size=${policy_hidden_size}
export reward_num_query_groups=${policy_num_query_groups}
export reward_num_attention_heads=${policy_num_attention_heads}
export reward_ffn_hidden_size=${policy_ffn_hidden_size}
